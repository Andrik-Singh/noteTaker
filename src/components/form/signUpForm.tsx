...
import { signUpSchema, SignUpType } from "@/zodSchema/signupSchema"
...
const SignUpForm = () => {
  ...
  return (
    <div className={"flex flex-col gap-6 w-screen mt-5 items-center justify-center"}>
      <Card className="xl:w-[520px] md:w-[480px] w-[300px] shadow-sm shadow-blue-600">
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="grid gap-6">
              ...
              <div className="relative text-center text-sm after:absolute after:inset-0 after:top-1/2 after:z-0 after:flex after:items-center after:border-t after:border-border">
                <span className="relative z-10 bg-background px-2 text-muted-foreground">Or continue with social</span>
              </div>
